-- ====================================================================
-- INNOW Digital Attendance Tracking System - Seed Data
-- ====================================================================
--
-- IMPORTANT: This file is disabled by default.
--
-- All staff and attendance data should be created through the
-- application UI, not via SQL imports. This ensures:
--   - PINs are hashed with bcrypt on creation
--   - Sessions and CSRF tokens are properly initialized
--   - Foreign keys and cascading deletes work correctly
--
-- If you need to reset the database to a clean state:
--   1. Do NOT run this file
--   2. Instead, run clean_seed_data.sql to remove only seed records
--   3. Or manually delete users through the Staff Directory UI
--
-- ====================================================================
